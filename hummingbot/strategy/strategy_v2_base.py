"""
TODO:
1. remodel the state and get average filled price and total filled amount
2. only check exit condition when open position is done (e.g. avg entry price is determined)
"""
