...
class ExchangePyBase(ExchangeBase, ABC):
    ...
    async def _update_trading_rules(self):
        ...
        self.logger().info(f"There are {len(exchange_info)} trading rules at _update_trading_rules")
    ...
    async def _initialize_trading_pair_symbol_map(self):
        try:
            ...
            self.logger().info(f"There are {len(exchange_info)} trading pairs at _make_trading_pairs_request")
            self._initialize_trading_pair_symbols_from_exchange_info(exchange_info=exchange_info)
        except Exception:
